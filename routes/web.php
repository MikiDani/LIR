...
Route::middleware(['web', 'auth', \App\Http\Middleware\LanguageMiddleware::class])->group(function() {
	...
	Route::get ('/admin/news/modify',	[BackendController::class, 'admin_news_modify'])->name('admin_news_modify');
	Route::post('/admin/news/modify',	[BackendController::class, 'admin_news_modify_post']);

	Route::get ('/admin/news/delete',	[BackendController::class, 'admin_news_delete'])->name('admin_news_delete');
	# ----
